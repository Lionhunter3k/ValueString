...
{
    public class StackAlbumFakeRazorPage_Heap : FakeRazorPage<List<StackAlbum>>
    {
        private readonly bool shouldAwait;

        public StackAlbumFakeRazorPage_Heap(List<StackAlbum> model, bool shouldAwait) : base(model)
        {
